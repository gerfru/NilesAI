...
class TestNormalizePhone:
    def test_plus_country_code(self):
        assert normalize_phone("+43 660 123 4567") == "436601234567"

    def test_leading_zero(self):
        assert normalize_phone("0660 123 4567") == "436601234567"

    def test_double_zero_prefix(self):
        assert normalize_phone("00436601234567") == "436601234567"

    def test_already_normalized(self):
        assert normalize_phone("436601234567") == "436601234567"

    def test_with_dashes(self):
        assert normalize_phone("+43-660-123-4567") == "436601234567"

    def test_with_parentheses(self):
        assert normalize_phone("+43 (660) 1234567") == "436601234567"

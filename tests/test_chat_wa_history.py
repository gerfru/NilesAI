...
class TestFetchWaHistory:
    ...
    async def test_jid_construction(self, wa_action):
        ...
        await _fetch_wa_history(wa_action, "436605875573", "niles-wa-1")

        wa_action.fetch_messages.assert_awaited_once_with("436605875573@s.whatsapp.net", instance="niles-wa-1")

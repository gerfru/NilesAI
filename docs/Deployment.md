...
**Important:** The Caddyfile contains hardcoded IPs (`192.168.1.x` = Tailscale, `192.168.1.x` = LAN). These must be adjusted for each deployment environment -- in **all three** server blocks (Niles Core :443, Evolution API :8443, Vikunja :3457).

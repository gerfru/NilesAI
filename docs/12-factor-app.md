...
**Hinweis:** Die `docker-compose.yml` enthält hardkodierte IPs im Caddyfile (`192.168.1.x`, `192.168.1.x`). Diese müssten pro Deployment angepasst werden. Das ist ein kleiner Verstoß gegen das Config-Prinzip — die IPs gehören in die `.env`.

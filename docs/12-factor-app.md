...
**Hinweis:** Die `docker-compose.yml` enthält hardkodierte IPs im Caddyfile (`100.85.159.70`, `192.168.0.248`). Diese müssten pro Deployment angepasst werden. Das ist ein kleiner Verstoß gegen das Config-Prinzip — die IPs gehören in die `.env`.

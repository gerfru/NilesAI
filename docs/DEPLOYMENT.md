...
**Wichtig:** Die Caddyfile enthaelt hartcodierte IPs (`192.168.1.100` = Tailscale, `192.168.1.100` = LAN). Diese muessen fuer jede Deployment-Umgebung angepasst werden -- in **allen drei** Server-Bloecken (Niles Core :443, Evolution API :8443, Vikunja :3457).

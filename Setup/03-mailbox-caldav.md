...
**URL-Format:** `https://dav.example.com/caldav/[KALENDER-ID]`
...
**URL:**
```
https://dav.example.com/caldav/Y2FsOi8vMC8zMQ/{{ $json.event_id }}.ics
```
...
curl -v -X PUT \
  ...
  https://dav.example.com/caldav/Y2FsOi8vMC8zMQ/test-curl.ics
```
